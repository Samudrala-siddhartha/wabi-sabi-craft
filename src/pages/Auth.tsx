...
const Auth: React.FC = () => {
  ...
  const { signIn, signUp, signInWithGoogle, user, role, needsRoleSelection, isLoading: authLoading } = useAuth();
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card rounded-lg border border-border p-8">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full font-body mb-4"
            ...
            {isLogin ? (
              ...
              <form onSubmit={signupForm.handleSubmit(handleSignup)} className="space-y-4">
                ...
                <Button 
                  ...
                  disabled={isLoading || isGoogleLoading || !signupForm.watch('role')}
                >
